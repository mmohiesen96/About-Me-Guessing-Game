...
function animate1() {
    if (!x) {
        ...
        document.getElementById("shuffle-right").style.left = "8%";
        document.getElementById("shuffle-right").style.transform = "rotateY(180deg)";
        x = true;
    }

    else{
        document.getElementById("side-bar").style.left = "-10%";
        document.getElementById("shuffle-right").style.left = "0";
        document.getElementById("shuffle-right").style.transform = "rotateY(0deg)";
        x = false;
    }
